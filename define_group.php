...
<div class="home-menu pure-menu pure-menu-horizontal">
	...
	<?php
	//echo "</br>Received groupID $_GET[groupid] ";
	...
	// echo "</br>You are creating a Live Event for $group[name] with groupID  $group[id] ";
           ...
           <h2 class="content-head is-center">Create Live Event</h2>
                           <form class="pure-form pure-form-stacked" method="POST" action="create.php">
                               <fieldset>
                                   ...
                                   <input type="text" name="grouptoken" id="grouptoken" value="$grouptoken" readonly="readonly">

                                   <label for="group">group</label>
                                   <input type="text" name="group" id="group" value="$group[name]" readonly="readonly">

                                   <label for="groupid">group ID</label>
                                   <input type="text" name="groupid" id="groupid" value="$group[id]" readonly="readonly">
