...
<div class="content">
	...
	<h2 class="content-head is-center">Select a group</h2>
	<div class="pagelist">
...
<?php
	...
	//requesting list of groups managed by user (requires permission)
	$groups = $fb->get('/me/groups')->getGraphEdge()->asArray();


//listing groups managed by user
//echo "</br>Please select the group you want to create a Live Video Event for:";
